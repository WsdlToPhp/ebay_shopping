 ...
 */
/**
 * EbayShoppingWsdlClass to communicate with SOAP service
 * Documentation : 837
 * @package EbayShopping
 * @date 2013-09-04
 * @author Mikaël DELSOL <contact@wsdltophp.com>
...
class EbayShoppingWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
	 ...
	 * @return EbayShoppingWsdlClass|null
	 */
	public static function __set_state(array $_array,$_className = __CLASS__)
	{
		if(class_exists($_className))
		{
			...
			if(is_object($object) && is_subclass_of($object,'EbayShoppingWsdlClass'))
			{
	 ...
	 * @uses EbayShoppingClassMap::classMap()
	 * @uses EbayShoppingWsdlClass::getDefaultWsdlOptions()
	 * @uses EbayShoppingWsdlClass::setSoapClient()
	 ...
	 * @uses EbayShoppingWsdlClass::getSoapClient()
	 * @uses EbayShoppingWsdlClass::getFormatedXml()
	 ...
	 * @uses EbayShoppingWsdlClass::getSoapClient()
	 * @uses EbayShoppingWsdlClass::convertStringHeadersToArray()
